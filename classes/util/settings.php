...
namespace theme_cul_moove\util;
...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('cul_moove');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/cul_moove/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/cul_moove/pix/default_markegingicon.svg');
