...
namespace theme_cul_moove\privacy;
...
class provider implements
    ...
    const FONTTYPE = 'themecul_moovesettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themecul_moovesettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themecul_moovesettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themecul_moovesettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                ...
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themecul_moovesettings_enableaccessibilitytoolbar', 'theme_cul_moove', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_cul_moove', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_cul_moove', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themecul_moovesettings_fonttype', 'theme_cul_moove', $fonttype)
            );
        }
    }
}
