    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var AccessibilityModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_cul_moove_getthemesettings',
                args: {}
            }]);
        ...
        AccessibilityModal.TYPE = 'theme_cul_moove-themesettings_modal';
        ...
        AccessibilityModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_cul_moove_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(AccessibilityModal.TYPE, AccessibilityModal, 'theme_cul_moove/accessibilitysettings_modal');
            registered = true;
        }
