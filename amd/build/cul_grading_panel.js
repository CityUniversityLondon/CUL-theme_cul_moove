 ...
 *
 * @module     theme_cul_moove/grading_panel
...
define(['jquery', 'core/yui', 'core/notification', 'core/templates', 'core/fragment',
    ...
    GradingPanel.prototype._gradeHiddenAlert = function() {
        ...
        window.M.util.js_pending('theme-cul_moove-loading-grade-alert');
        ...
        if (this._lastUserId > 0) {
            ...
            fragment.loadFragment('theme_cul_moove', 'gradealert', contextid, params).done(function(html, js) {
                this._nicePrependGradeAlertContents(gradingform, html, js)
                .done(function() {
                    // Tell behat we are friends again.
                    window.M.util.js_complete('theme-cul_moove-loading-grade-alert');
                }.bind(this))
