...
$string['privacy:metadata:preference:themecul_moovesettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themecul_moovesettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['searchadmin'] = 'Search admin settings';
